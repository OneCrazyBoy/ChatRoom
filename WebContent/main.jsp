...
window.setInterval("showContent();",1000);  //浏览器每隔1s就执行showContent()函数
window.setInterval("showOnline();",1000);
var sysBBS="<span style='font-size:14px; line-height:30px;'>欢迎光临心之语聊天室，请遵守聊天室规则，不要使用不文明用语,谢谢大家配合！。</span><br><span style='line-height:22px;'>";
...
<form action="" name="form1" method="post" > <!--一个大的表单form1,描述的是主界面对话信息-->
  <tr>
...
说：</td>
  ...
  <tr>
    <td height="30" align="left">&nbsp;</td>
    <td colspan="2" align="center" class="word_dark">&nbsp;All CopyRights reserved 2015 NEUQ-葛爱军</td>
    <td align="center">&nbsp;</td>
  </tr>
</form>
</table>
